      ...
      <div className="container mx-auto">
        <div className="flex flex-col gap-y-8 md:flex-row md:gap-x-12 md:items-center">
          <div className="flex-1 text-center font-secondary md:text-left">
            <h1 className="text-[55px] leading-[0.8] font-bold md:text-[110px] ">
              Ben
              <span> AYDEN</span>
            </h1>
            <div className="mb-6 text-[36px] md:text-[60px] font-secondary font-semibold uppercase leading-[1]">
            ...
            <div className="flex max-w-max gap-x-6 items-center mx-auto mb-16 md:mx-0">
